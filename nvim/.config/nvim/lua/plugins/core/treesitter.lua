...
return {
    {
        ...
        config = function()
            ...
            local no_ts_indent = { yaml = true } -- TS indent misbehaves here
            ...
            vim.api.nvim_create_autocmd('FileType', {
                ...
                callback = function(ev)
                    ...
                    -- Do nothing unless a parser is actually installed for
                    -- this language. This stops the errors on a fresh start
                    -- (parsers still compiling) and on filetypes that have no
                    -- parser at all.
                    ...
                    -- Indentation (still experimental upstream, guarded per ft)
